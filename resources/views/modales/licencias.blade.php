...
<div class="col-md-4">
  ...
  <input type="text" class="form-control" name="licencia" id="licencia"
@if(isset($cliente))
readonly value="{{$cliente->licencia->nlicencia}}">  
@else
placeholder="licencia">
     @endif
...
<div class="col-md-4">
    ...
    <input  type="text" class="form-control" name="clase" id="clase"
    @if(isset($cliente))
readonly value="{{$cliente->licencia->clase}}"
     @else
    placeholder="clase"
     @endif
    >
...
<div class="col-md-4">
    ...
    <input  type="text" class="form-control" name="expira" id="expira"
    @if(isset($cliente))
readonly value="{{$cliente->licencia->expira}}"
     @else
    placeholder="expira"
     @endif
     >
...
<div class="col-md-4">
    ...
    <input  type="text" maxlength = '20' class="form-control" name="estadoLicencia" id="estado"
@if(isset($cliente))
readonly value="{{$cliente->licencia->estado}}"
     @else
    placeholder="estado"
     @endif
   >
