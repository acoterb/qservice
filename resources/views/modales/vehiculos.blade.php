...
<div class="col-md-4">
  ...
  <input  type="text" class="form-control" name="marca" id="marca"
@if(isset($cliente))
readonly value="{{$cliente->vehiculo->marca}}">  
@else
placeholder="marca">
     @endif
...
<div class="col-md-4">
    ...
    <input  type="text" class="form-control" name="submarca" id="submarca"
    @if(isset($cliente))
readonly value="{{$cliente->vehiculo->submarca}}"
     @else
    placeholder="submarca"
     @endif
    >
...
<div class="col-md-4">
    ...
    <input  type="text" class="form-control" name="tipo" id="tipo"
@if(isset($cliente))
readonly value="{{$cliente->vehiculo->tipo}}"
...
<div class="col-md-4">
    ...
    <input  type="text" class="form-control" name="modelo" id="modelo"
    @if(isset($cliente))
readonly value="{{$cliente->vehiculo->modelo}}"
     @else
    placeholder="modelo"
     @endif
     >
...
<div class="col-md-4">
    ...
    <input  type="text" maxlength = '20' class="form-control" name="servicio" id="servicio"
@if(isset($cliente)) 
readonly value="{{$cliente->vehiculo->servicio}}"
     @else
...
<div class="col-md-4">
    ...
    <input  type="text" maxlength = '20' class="form-control" name="color" id="color"
@if(isset($cliente))
readonly value="{{$cliente->vehiculo->color}}"
     @else
    placeholder="color"
     @endif
   >
...
<div class="col-md-4">
    ...
    <input  type="text" maxlength = '20' class="form-control" name="placas" id="placas"
@if(isset($cliente))
readonly value="{{$cliente->vehiculo->placas}}"
     @else
    placeholder="placas"
     @endif
   >
...
<div class="col-md-4">
    ...
    <input  type="text" maxlength = '20' class="form-control" name="estadoVehiculo" id="estado"
@if(isset($cliente))
readonly value="{{$cliente->vehiculo->estado}}"
     @else
    placeholder="estado"
     @endif
   >
...
<div class="col-md-4">
    ...
    <input  type="text" maxlength = '20' class="form-control" name="serie" id="serie"
@if(isset($cliente))
readonly value="{{$cliente->vehiculo->nserie}}"
     @else
    placeholder="# de serie"
     @endif
   >
...
<div class="col-md-4">
    ...
    <input  type="text" maxlength = '20' class="form-control" name="registro" id="registro"
@if(isset($cliente))
readonly value="{{$cliente->vehiculo->nregistro}}"
     @else
    placeholder="# de registro"
     @endif
   >
...
<div class="col-md-4">
    ...
    <input  type="text" maxlength = '20' class="form-control" name="motor" id="motor"
@if(isset($cliente))
readonly value="{{$cliente->vehiculo->nmotor}}"
     @else
    placeholder="# de motor"
     @endif
   >
